...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "$BUILT_PRODUCTS_DIR/FLTextView/FLTextView.framework"
  ...
  install_framework "$BUILT_PRODUCTS_DIR/ThreeDegreesClient/ThreeDegreesClient.framework"
